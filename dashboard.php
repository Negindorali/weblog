            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0" style="background-color: black">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li>
                            <a href="/blog/index.php" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi-speedometer2"></i> <span class="ms-1 d-none d-sm-inline text-white">blogs</span> </a>
                        </li>
                        <li>
                            ...
                            <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                                ...
                                <li>
                                    <a href="" class="nav-link px-0">
                                        ...
                                        <span class="d-none d-sm-inline text-white">product4</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <!--                            <span class="d-none d-sm-inline text-white mx-1">loser</span>-->
                    <!--                        </a>-->
